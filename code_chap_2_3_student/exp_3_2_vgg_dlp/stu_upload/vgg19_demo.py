...
class VGG19(object):
    ...
    def build_model(self, param_path='../../imagenet-vgg-verydeep-19.mat'):
        ...
        input_shape1[0], input_shape1[1], input_shape1[2], input_shape1[3] = 1, 3, 224, 224
        self.net.createConvLayer('conv1_1', input_shape1, 64, 3, 1, 1, 1)
        self.net.createReLuLayer('relu1_1')

        input_shape2 = pycnnl.IntVector(4)
        input_shape2[0], input_shape2[1], input_shape2[2], input_shape2[3] = 1, 64, 224, 224
        self.net.createConvLayer('conv1_2', input_shape2, 64, 3, 1, 1, 1)
        self.net.createReLuLayer('relu1_2')

        input_shapep1 = pycnnl.IntVector(4)
        input_shapep1[0], input_shapep1[1], input_shapep1[2], input_shapep1[3] = 1, 64, 224, 224
        self.net.createPoolingLayer('pool1',input_shapep1, 2, 2)  # 224 → 112

        # ========== Conv Block 2 ==========
        input_shape3 = pycnnl.IntVector(4)
        input_shape3[0], input_shape3[1], input_shape3[2], input_shape3[3] = 1, 64, 112, 112
        self.net.createConvLayer('conv2_1', input_shape3, 128, 3, 1, 1, 1)
        self.net.createReLuLayer('relu2_1')

        input_shape4 = pycnnl.IntVector(4)
        input_shape4[0], input_shape4[1], input_shape4[2], input_shape4[3] = 1, 128, 112, 112
        self.net.createConvLayer('conv2_2', input_shape4, 128, 3, 1, 1, 1)
        self.net.createReLuLayer('relu2_2')

        input_shapep2 = pycnnl.IntVector(4)
        input_shapep2[0], input_shapep2[1], input_shapep2[2], input_shapep2[3] = 1, 128, 112,112
        
        self.net.createPoolingLayer('pool2',input_shapep2 ,2, 2)  # 112 → 56

        # ========== Conv Block 3 ==========
        input_shape5 = pycnnl.IntVector(4)
        input_shape5[0], input_shape5[1], input_shape5[2], input_shape5[3] = 1, 128, 56, 56
        self.net.createConvLayer('conv3_1', input_shape5, 256, 3, 1, 1, 1)
        self.net.createReLuLayer('relu3_1')

        input_shape6 = pycnnl.IntVector(4)
        input_shape6[0], input_shape6[1], input_shape6[2], input_shape6[3] = 1, 256, 56, 56
        self.net.createConvLayer('conv3_2', input_shape6, 256, 3, 1, 1, 1)
        self.net.createReLuLayer('relu3_2')

        self.net.createConvLayer('conv3_3', input_shape6, 256, 3, 1, 1, 1)
        self.net.createReLuLayer('relu3_3')

        self.net.createConvLayer('conv3_4', input_shape6, 256, 3, 1, 1, 1)
        self.net.createReLuLayer('relu3_4')


        input_shapep3 = pycnnl.IntVector(4)
        input_shapep3[0], input_shapep3[1], input_shapep3[2], input_shapep3[3] = 1, 256, 56,56
        self.net.createPoolingLayer('pool3',input_shapep3,2, 2)  # 56 → 28

        # ========== Conv Block 4 ==========
        input_shape7 = pycnnl.IntVector(4)
        input_shape7[0], input_shape7[1], input_shape7[2], input_shape7[3] = 1, 256, 28, 28
        self.net.createConvLayer('conv4_1', input_shape7, 512, 3, 1, 1, 1)
        self.net.createReLuLayer('relu4_1')

        input_shape8 = pycnnl.IntVector(4)
        input_shape8[0], input_shape8[1], input_shape8[2], input_shape8[3] = 1, 512, 28, 28
        self.net.createConvLayer('conv4_2', input_shape8, 512, 3, 1, 1, 1)
        self.net.createReLuLayer('relu4_2')

        self.net.createConvLayer('conv4_3', input_shape8, 512, 3, 1, 1, 1)
        self.net.createReLuLayer('relu4_3')

        self.net.createConvLayer('conv4_4', input_shape8, 512, 3, 1, 1, 1)
        self.net.createReLuLayer('relu4_4')

        input_shapep4 = pycnnl.IntVector(4)
        input_shapep4[0], input_shapep4[1], input_shapep4[2], input_shapep4[3] = 1, 512, 28,28
        self.net.createPoolingLayer('pool4', input_shapep4,2, 2)  # 28 → 14

        # ========== Conv Block 5 ==========
        input_shape9 = pycnnl.IntVector(4)
        input_shape9[0], input_shape9[1], input_shape9[2], input_shape9[3] = 1, 512, 14, 14
        self.net.createConvLayer('conv5_1', input_shape9, 512, 3, 1, 1, 1)
        self.net.createReLuLayer('relu5_1')

        self.net.createConvLayer('conv5_2', input_shape9, 512, 3, 1, 1, 1)
        self.net.createReLuLayer('relu5_2')

        self.net.createConvLayer('conv5_3', input_shape9, 512, 3, 1, 1, 1)
        self.net.createReLuLayer('relu5_3')

        self.net.createConvLayer('conv5_4', input_shape9, 512, 3, 1, 1, 1)
        self.net.createReLuLayer('relu5_4')

        input_shapep5 = pycnnl.IntVector(4)
        input_shapep5[0], input_shapep5[1], input_shapep5[2], input_shapep5[3] = 1, 512,14,14
        
        self.net.createPoolingLayer('pool5',input_shapep5 ,2, 2)  # 14 → 7

        # ========== Flatten Layer ==========
        #// self.net.createFlattenLayer('flatten')

        input_shapem1=pycnnl.IntVector(4)
        input_shapem1[0]=1
        input_shapem1[1]=1
        input_shapem1[2]=1
        input_shapem1[3]=25088 #输入通道数
